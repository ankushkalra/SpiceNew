...
<body>
	...
	<div class="container">
		...
		<?php
			$sq = $_GET['sq'];
			$query = "SELECT * FROM products where p_name LIKE '%$sq%' LIMIT 12";
		...
		<div class="col-md-3 col-sm-6">
			<form method="post" action="shop.php?action=add&id=<?php echo $row['id']; ?>">
				<div class="product-container">
					<img src="/phpw3/upload_image/admin/<?php echo $row['image']; ?>" class="img-responsive" style="margin-left:auto; margin-right: auto;">
